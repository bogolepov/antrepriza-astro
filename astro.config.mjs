...
function isNoIndex(url) {
  ...
  if (lowUrl.includes('https://antrepriza.eu/ru/theater/people/') || lowUrl.includes('https://antrepriza.eu/de/theater/people/')) {
    ...
    if (i !== -1 && i < urlArr.length - 1 && urlArr[i + 1] === 'alm') return false;else return true;
  }
  return false;
}
...
export default defineConfig({
  ...
  integrations: [react(), sitemap({
    filter: page => page !== 'https://antrepriza.eu/404/' && page !== 'https://antrepriza.eu/ru/404/' && page !== 'https://antrepriza.eu/de/404/' && page !== 'https://antrepriza.eu/ru/newsletter/' && page !== 'https://antrepriza.eu/de/newsletter/',
    // i18n: {
    // 	defaultLocale: 'ru',
    // 	locales: {
    // 		ru: 'ru-RU',
